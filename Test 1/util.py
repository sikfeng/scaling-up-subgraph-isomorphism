...
print("Found {} substructures, SGI run {} times".format(len(isomorphicDirect), numSGIRun))

# SGI with raph signatures
print("\ngraph signatures")
startSGITime = time.time() 
numSGIRun = 0
class graphSig: 
...
print("Found {} substructures, SGI run {} times".format(len(isomorphicSig), numSGIRun))
